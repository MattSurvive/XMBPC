...
Public Class MusicPlayer
    ...
    Public myplayervolume As Integer
    ...
    Private Sub MusicPlayer_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        ...
        myplayervolume = 50
        'myplayer.SetMasterVolume(50, 50)
        myplayer.SetPlayerVolume(50, 50)
    ...
    Private Sub ControllerInputTimer_Tick(sender As Object, e As EventArgs) Handles ControllerInputTimer.Tick
        ...
        myplayer.SetPlayerVolume(myplayervolume, myplayervolume)
        ...
        ElseIf status.IsButtonPressed(AForge.Controls.Joystick.Buttons.Button5) = True Or GetAsyncKeyState(Keys.H) Then
            If myplayervolume = 100 Then
                myplayervolume = myplayervolume
            Else
                myplayervolume = myplayervolume + 5
            End If
        ElseIf status.IsButtonPressed(AForge.Controls.Joystick.Buttons.Button7) = True Or GetAsyncKeyState(Keys.N) Then
            If myplayervolume = 0 Then
                myplayervolume = myplayervolume
            Else
                myplayervolume = myplayervolume - 5
            End If
        ...
        If CurrentPlayStatus.Focused = True And status.IsButtonPressed(AForge.Controls.Joystick.Buttons.Button3) = True Or GetAsyncKeyState(Keys.Enter) Then
            If myplayerstatus.fPlay Then
