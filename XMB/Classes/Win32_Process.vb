...
Public Class Win32_Process
    ...
    Public Sub New(ByVal keyHandle As String)
        MyBase.New()
        Me.InitializeObject(Nothing, New System.Management.ManagementPath(Win32_Process.ConstructPath(keyHandle)), Nothing)
    End Sub

    Public Sub New(ByVal mgmtScope As System.Management.ManagementScope, ByVal keyHandle As String)
        MyBase.New()
        Me.InitializeObject(CType(mgmtScope, System.Management.ManagementScope), New System.Management.ManagementPath(Win32_Process.ConstructPath(keyHandle)), Nothing)
    End Sub
    ...
    <Browsable(True)> _
    Public Shared Function CreateInstance() As Win32_Process
    ...
    Public Class ProcessCollection
        ...
        Public Overridable Sub CopyTo(ByVal array As System.Array, ByVal index As Integer) Implements System.Collections.ICollection.CopyTo
            ...
            Do While (nCtr < array.Length)
                array.SetValue(New Win32_Process(CType(array.GetValue(nCtr), System.Management.ManagementObject)), nCtr)
                nCtr = (nCtr + 1)
            Loop
        End Sub
        ...
        Public Class ProcessEnumerator
            ...
            Public Overridable ReadOnly Property Current() As Object Implements System.Collections.IEnumerator.Current
                Get
                    Return New Win32_Process(CType(privObjEnum.Current, System.Management.ManagementObject))
                End Get
            End Property
