...
Public Class Functions
    ...
    Public Shared Sub LoadP3T(ByVal theme As String)
        ...
        FileBrowser.Cursor = Cursors.WaitCursor
        XMB.Cursor = Cursors.WaitCursor
        ...
        If ThemeLoader.HasExited Then
            ...
            XMB.BrowserBox.Image = Image.FromFile(".\extracted." + Path.GetFileName(theme) + "\icon_network_1.gim.png")
            ...
            XMB.SettingsUpdate.Image = Image.FromFile(".\extracted." + Path.GetFileName(theme) + "\icon_update_1.gim.png")
            XMB.Game1.Image = Image.FromFile(".\extracted." + Path.GetFileName(theme) + "\icon_gamedata_1.gim.png")
            ...
            FileBrowser.Cursor = Cursors.Default
            XMB.Cursor = Cursors.Default
        End If
